...
ArticleSelection::ArticleSelection(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::ArticleSelection)
{
    ui->setupUi(this);
}
...
void ArticleSelection::m_ManageRecommendDisplay(int num_1, int num_2, int num_3, int num_4, int num_5)
{
    m_Recommend[1] = num_1;
    m_Recommend[2] = num_2;
    m_Recommend[3] = num_3;
...
void ArticleSelection::m_ManageButtonClick1()
{
    emit m_OpenNewArticle(m_Recommend[1]);
}
void ArticleSelection::m_ManageButtonClick2()
{
    emit m_OpenNewArticle(m_Recommend[2]);
}
void ArticleSelection::m_ManageButtonClick3()
{
    emit m_OpenNewArticle(m_Recommend[3]);
}
void ArticleSelection::m_ManageButtonClick4()
{
    emit m_OpenNewArticle(m_Recommend[4]);
}
void ArticleSelection::m_ManageButtonClick5()
{
